...
export default function AdminUsersPage() {
  ...
  const allowed = status === 'authenticated' && session.user.role === 'OWNER'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Setup Akun</h1>
            <p className="text-sm text-gray-500">Kelola akun tim dan role akses aplikasi</p>
          </div>
        </div>
