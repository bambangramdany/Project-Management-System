...
async function main() {
  ...
  const projectsData = [
    // Active pipeline
    { code: 'P-001', name: 'Strategic Deployment', clientName: 'PT Integrasi Transit Jakarta', category: 'MEETING_CONFERENCE', budgetTier: 'LOW', eventComplexity: 'SIMPLE', recommendation: 'MAINTAIN', picName: 'Irham', status: 'HOLD', pitchStatus: 'PITCH', pitchResult: 'NOT_FINAL', members: ['Irham','Doddi','Eca'] },
    { code: 'P-002', name: 'HUT DKI JAKARTA : Fun Run 2026', clientName: 'HIPMI', category: 'ACTIVATION', budgetTier: 'HIGH', eventComplexity: 'COMPLEX', recommendation: 'MAINTAIN', picName: 'Wulan', briefDate: new Date('2026-02-27'), submitDate: new Date('2026-03-30'), pitchDuration: 32, startDate: new Date('2026-06-01'), status: 'HOLD', pitchStatus: 'PITCH', pitchResult: 'NOT_FINAL', members: ['Wulan','Doddi','Syaifullah','Kres','Saffira'] },
    { code: 'P-003', name: 'Grand Opening BSD Office', clientName: 'Midea MBT', category: 'LAUNCHING', budgetTier: 'MEDIUM', eventComplexity: 'MEDIUM', recommendation: 'MAINTAIN', picName: 'Wulan', briefDate: new Date('2026-01-26'), submitDate: new Date('2026-03-12'), pitchDuration: 46, startDate: new Date('2026-05-17'), endDate: new Date('2026-05-17'), projectDuration: 1, status: 'HOLD', pitchStatus: 'PITCH_PLUS', pitchResult: 'NOT_FINAL', wonLossReason: 'Budget', members: ['Wulan','Reghy','Doddi','Boni','Syaifullah'] },
