...
const PEOPLE = [
  ...
  },
  {
    ...
    accentText: '#064E3B',
    levelLabel: 'GA',
    intro: 'Kamu bertanggung jawab atas kebutuhan operasional kantor dan mendukung mobilitas tim sebagai driver kantor. Di sistem, tugasmu sederhana — check-in setiap hari dan update task jika ada yang ditugaskan.',
    menus: [
    ...
    steps: [
      ...
      { title: 'Kerjakan task jika ada', desc: 'Jika ada task yang ditugaskan (pengantaran, keperluan kantor, dsb.), klik task → Update Progres setelah selesai.' },
      { title: 'Self-assessment bulanan', desc: 'Penilaian → Penilaian Diri → isi self-assessment kamu setiap awal bulan.' },
    ],
    tip: 'Cukup check-in setiap hari. Untuk keperluan antar-jemput atau operasional kantor, koordinasikan dengan Anung atau atasan yang menugaskan.',
  },
